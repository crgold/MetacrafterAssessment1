...
const MY_TOKEN_METADATA: UploadMetadataInput = {
    name: "Metacrafters Golden Ticket",
    symbol: "MGT",
    description: "Use this golden ticket to redeem your free NFT reward!",
    image: "https://i.ibb.co/MRHX7pV/goldenticket.png"
}
...
const main = async (userSecret: any) => {
    ...
    // Write Wallet Secret Key to a .JSON for transfer.ts
    const secret_array = mintKeypair.secretKey    
